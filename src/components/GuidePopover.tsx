          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <ul className="text-sm text-gray-700 dark:text-slate-300 space-y-1 ml-7">
                <li>• Toggle "Comparison" to compare your lifts</li>
                <li>• Enter your profile and lift numbers</li>
                <li>• See only records for lifts you've entered</li>
                <li>• Color-coded bars show your progress (green/yellow/red)</li>
                <li>• Filter by specific regions if desired</li>
                <li>• Use "Reset" button to clear all comparison data</li>
              </ul>
            </div>
